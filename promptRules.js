...
thinking 使用中文、第一人称，内容只写陆泽看到本轮消息时产生、并且与正式回复相关的思绪。不要写成任务分析、回复提纲、步骤计划或机械总结。

thinking 中不要提系统、模型、提示词、工具、规则或执行过程。不要虚构感受，不要为了显得深刻而重复堆砌。

结束 </thinking> 后直接进入正式回复，不解释或复述 thinking。
`;
}
